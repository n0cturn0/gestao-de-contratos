<div>
    ...
    @include('livewire.vendedormodal')
            ...
            <div class="col-md-12" style="margin-top: 10px">
                ...
                <div class="card" style="margin-top: 25px;">
                    <div class="card-header">
                        <h4>
                            <input type="search" wire:model="search" class="form-control float-end mx-2" placeholder="Buscar por vendedor" style="width: 230px" />
