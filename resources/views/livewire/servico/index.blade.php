            ...
            <div class="col-md-12" style="margin-top: 10px">
                ...
                <div class="card" style="margin-top: 25px;">
                    <div class="card-header">
                        <h4>
                            <input type="search" wire:model="search" class="form-control float-end mx-2" placeholder="Buscar Serviço" style="width: 230px" />
...
{{--                                    <td></td>--}}
                            ...
                            @empty
                                <tr>
                                    <td colspan="5">Sem serviço cadastrado</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
